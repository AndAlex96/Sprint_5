...
def test_transfer_to_personal_account(setup_registration, random_email):
    ...
    driver.find_element(By.XPATH, "/html/body/div/div/main/div/nav/ul/li[3]/button").click() # кнопка Выход
    WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable((By.XPATH, "/html/body/div/div/header/nav/a/p")))
    driver.find_element(By.XPATH, "/html/body/div/div/header/nav/a/p").click() # проверяем переход в ЛК
